...
\begin{itemize}
    ...
    \item \textbf{Creazione Itinerario Casuale (Assistita):} Generazione automatica basata su percorsi esistenti o nuovi, con la possibilità di definire tempistiche specifiche per la visita.
