...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Iterazione0/Diagrammi/DiagrammaCasiDusoV2.png}
    \caption{Casi d'uso}
...
\end{itemize} 
    ...
    \item \textbf{UC16 - Elimina viaggio:} l'utente può eliminare un viaggio già creato.
\end{itemize}